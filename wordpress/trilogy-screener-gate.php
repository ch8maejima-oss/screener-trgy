...
// 期限切れ後は再購入。
// TODO: EA EXPOで下記3商品を作成後、実際の投稿IDに差し替えること（現在はプレースホルダー）。
// - screener-001: スクリーニング銘柄一覧／30日間プラン
// - screener-002: スクリーニング銘柄一覧／半年プラン（180日間）
// - screener-003: スクリーニング銘柄一覧／1年プラン（365日間）
// プレースホルダーの投稿ID（999901〜999903）は実際のWordPress投稿IDと衝突しないよう
// 大きな値にしてある。EA EXPOで商品作成後、必ず実際の投稿IDに差し替えること。
define('TRILOGY_SCREENER_PRODUCTS', [
    999901 => 30,   // TODO: 30日間プランの投稿IDに差し替える
    999902 => 180,  // TODO: 半年プランの投稿IDに差し替える
    999903 => 365,  // TODO: 1年プランの投稿IDに差し替える
]);
